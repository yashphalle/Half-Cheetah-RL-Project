...
methods = {
    'Anti Inversion': ['anti_inversion_ppo_training.txt','anti_inversion_ppo_training2.txt'],
    'Efficient Cheetah': ['efficient_cheetah_ppo_training.txt','efficient_cheetah_ppo_training2.txt'],
    'Gait Optimization': ['gait_optimization_ppo_training.txt','gait_optimization_ppo_training2.txt'],
