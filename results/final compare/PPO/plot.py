...
methods = {
    'Anti Inversion': ['anti_inversion_ppo_training.txt'],
    'Efficient Cheetah': ['efficient_cheetah_ppo_training.txt'],
    'Gait Optimization': ['gait_optimization_ppo_training.txt'],
    'Default': ['default.txt']
}
